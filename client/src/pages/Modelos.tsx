...
import { Facebook, Twitter, Instagram, Phone, Share2, Star } from "lucide-react";
        ...
        <div className="container mx-auto px-2 sm:px-4">
          <div className="flex items-center justify-between h-12 sm:h-14 md:h-16 lg:h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              ...
              <Link href="/modelos" className="text-primary transition-colors font-medium">MODELOS</Link>
